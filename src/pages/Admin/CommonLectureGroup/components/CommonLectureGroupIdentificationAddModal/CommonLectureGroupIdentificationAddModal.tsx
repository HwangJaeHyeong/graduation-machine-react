...
import { postCommonLectureGroupIdentifications } from 'apis/commonLectureGroups/postCommonLectureGroupIdentifications'
...
type CommonLectureGroupIdentificationAddModalProps = {
  className?: string
  commonLectureGroupId: number
  updateCommonLectureGroupIdentificationList: () => void
}

export const CommonLectureGroupIdentificationAddModal: FC<CommonLectureGroupIdentificationAddModalProps> = ({
  className,
  ...
  const onClickSubmit = () => {
    ...
    postCommonLectureGroupIdentifications({ commonLectureGroupId, type, keyword }).then((res) => {
      if (res.success) {
